  ...
  return (
    <Box sx={{ minWidth: "30%", marginTop: 10 }}>
      <FormControl fullWidth>
        <InputLabel style={{ fontSize: 30 }} id="demo-simple-select-label">
          hekma Select
        </InputLabel>
        <Select
          //   variant="filled"
          style={{ fontSize: 25, paddingBlock: 5 }}
        ...
        >
          <MenuItem style={{ fontSize: 30 }} value={10}>
          ...
          <MenuItem style={{ fontSize: 30 }} value={40}>
